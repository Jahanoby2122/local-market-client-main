...
const LoadingScreen = ({ icon = '⏳', title = 'Loading', subtitle = 'Please wait...' }) => {
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-green-50 via-blue-50 to-emerald-50 flex flex-col items-center justify-center z-50">
